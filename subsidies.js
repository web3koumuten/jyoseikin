...
const SUBSIDIES = [
  ...
  },
  {
    ...
    "q14_key": "it-donyu",
    "max_amount": 4500000,
    "amount_note": "【2026年度改定・申請受付開始2026年3月30日〜】①通常枠（1〜3プロセス）：5〜150万円未満、補助率1/2（最低賃金近傍事業者は2/3）。②通常枠（4プロセス以上）：150〜450万円、補助率1/2（最低賃金近傍2/3）。③インボイス枠（インボイス対応類型）：最大350万円、補助率50万円以下3/4（小規模4/5）・50万円超2/3。④セキュリティ対策推進枠：5〜150万円、補助率中小1/2・小規模2/3",
    "timing": "before_investment",
    "lead_time_months": 2,
    "difficulty": 1,
    "company_size": [
    ...
    "description": "2026年度より「デジタル化・AI導入補助金」に名称変更・拡充。会計・勤怠・受発注・在庫管理・AI活用・ECサイト・クラウドサービスなど幅広いITツールが対象。通常枠は5〜450万円（補助率1/2、最低賃金近傍事業者は2/3）。インボイス対応類型は最大350万円（50万円以下3/4・小規模4/5、50万円超2/3）。認定ITベンダー経由で申請でき難易度が低く、2026年3月30日より申請受付開始。製造業でもAI検品・生産管理システムなどに活用可能です。",
    "conditions": [
  ...
  },
  {
    ...
    "q14_key": "monozukuri",
    "max_amount": 25000000,
    "amount_note": "【製品・サービス高付加価値化枠（通常）】対象経費の1/2（小規模・赤字は2/3）、上限750万円〜2,500万円（51人以上）。※2026年8月以降、新事業進出補助金と統合し「新事業進出・ものづくり商業サービス補助金」として再編予定",
    "timing": "before_investment",
    "lead_time_months": 12,
    "difficulty": 3,
    "company_size": [
    ...
    "description": "革新的な製品・サービスの開発や生産プロセス改善のための設備投資を補助する制度。機械装置・システム構築・専門家費用などが対象で、上限は通常枠750万円〜2,500万円（51人以上）。2026年8月以降は新事業進出補助金と統合し再編予定。審査が厳しく、革新性・付加価値向上の説得力ある事業計画書の作成が採択の鍵です。",
    "conditions": [
  ...
  },
  {
    ...
    "q14_key": "shooryoka",
    "max_amount": 10000000,
    "amount_note": "【2026年3月19日改定】補助率1/2（小規模・再生事業者は2/3）。通常上限：従業員5人以下→500万円（改定前200万円）、6〜20人→750万円、21人以上→1,000万円。大幅賃上げ特例時（事業場内最低賃金3%以上増）：5人以下→750万円、6〜20人→1,000万円、21人以上→1,500万円。収益納付ルール撤廃。申請受付2027年3月末まで延長",
    "timing": "before_investment",
    "lead_time_months": 6,
    "difficulty": 2,
    "company_size": [
    ...
    "requires_employee_insurance": false,
    "min_employees": 0,
    "note_eligibility": "カタログ掲載製品からの選択が必須。社会福祉法人・NPO等は対象外。2026年3月19日改定で通常上限が大幅引き上げ（5人以下200万→500万円、6〜20人は750万円）。大幅賃上げ特例でさらに上乗せ可",
  ...
  },
  {
    ...
    "max_amount": 70000000,
    "amount_note": "対象経費の1/2（上限7,000万円、賃上げ特例で最大9,000万円）。【第4回公募：2026年6月19日締切済み。採択発表：2026年9月末頃予定。第4回が現行制度の最終回】※2026年度中にものづくり補助金と統合→「新事業進出・ものづくり商業サービス補助金」予定",
    "timing": "before_investment",
    "lead_time_months": 12,
    "difficulty": 3,
    "company_size": [
    ...
    "requires_employee_insurance": false,
    "min_employees": 0,
    "note_eligibility": "社会福祉法人・医療法人・NPO等は対象外。認定支援機関の確認が必須。【第4回は現行制度の最終回・締切済み】2026年度中にものづくり補助金と統合（「新事業進出・ものづくり商業サービス補助金」）予定のため、次回公募は統合後の新制度を確認のこと",
  ...
  },
  {
    ...
    "max_amount": 6000000,
    "amount_note": "専門家費用・廃業費用等の2/3（上限最大600万円）。事業承継促進枠・専門家活用枠（売り手・買い手支援）各上限600万円。廃業・再チャレンジ枠・PMI推進枠上限150万円。【第15次公募：2026年6月19日〜7月24日受付中】",
    "timing": "before_investment",
    "lead_time_months": 9,
    "difficulty": 2,
    "company_size": [
  ...
  },
  {
    ...
    "q14_key": "jinzai",
    "max_amount": 500000,
    "amount_note": "訓練費の45%（中小企業）＋賃金助成 1人1時間800円（令和8年度改定。通常分。資格等手当要件を満たす場合は+200円で計1,000円）",
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 1200000,
    "amount_note": "重度身体・知的障害者・精神障害者：120万円/人。重度以外の身体・知的障害者・発達障害者・難病患者：90万円/人（中小企業）",
    "timing": "after_hire",
    "lead_time_months": 9,
    "difficulty": 2,
    "company_size": [
    ...
    "description": "有期雇用の障害者を正社員に転換した際に1人あたり90〜120万円を支給する助成金。重度身体・知的・精神障害者は120万円、重度以外・発達障害者・難病患者は90万円（中小企業）。障害者手帳等の確認が必要で、トライアル雇用→特定就職困難者コースと組み合わせて段階的に申請するのが王道です。",
    "conditions": [
      "キャリアアップ計画書を転換前に提出",
      "転換後6ヶ月雇用継続",
      "転換後賃金3%以上増加",
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 70000,
    "amount_note": "昇給率別 4〜7万円/人（中小のみ）。3%以上4%未満→4万円、4%以上5%未満→5万円、5%以上6%未満→6.5万円、6%以上→7万円。1事業所年間100人が上限",
    "timing": "after_raise",
    "lead_time_months": 6,
    "difficulty": 2,
    "company_size": [
    ...
    "requires_employee_insurance": true,
    "min_employees": 1,
    "note_eligibility": "中小企業のみ対象。大企業は対象外。有期雇用労働者の賃金を3%以上引き上げること。1事業所あたり年間100人が上限",
    "description": "有期雇用労働者の賃金を3%以上引き上げ、就業規則に賃金規定を整備した中小企業に支給される助成金。昇給率に応じて1人あたり4〜7万円（年間100人上限）。正社員化コースや賞与制度コースと組み合わせて受給額を積み上げられます。",
    "conditions": [
      "3%以上の賃金引上げ",
      "就業規則に賃金規定を整備",
      "キャリアアップ計画書を事前提出"
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 600000,
    "amount_note": "中小企業：1事業所60万円、大企業：45万円",
    "timing": "after_raise",
    "lead_time_months": 6,
    "difficulty": 3,
    "company_size": [
    ...
    "description": "正規・非正規社員の賃金規定を共通化（同一労働同一賃金の実現）した事業主に支給される助成金。中小企業60万円、大企業45万円（1事業所）。共通の賃金表を就業規則に整備し、6ヶ月分の賃金を支払った実績が必要です。難易度はやや高いですが、正社員化コースとセットで申請すると受給額が大きくなります。",
    "conditions": [
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 568000,
    "amount_note": "いずれかのみ導入：40万円（中小）/ 賞与＋退職金を同時導入：56.8万円（中小）。大企業はそれぞれ30万円・42.6万円",
    ...
    "description": "有期雇用労働者に新たに賞与または退職金制度を設け、実際に支給した事業主に支給される助成金。いずれか一方のみ導入：40万円（中小企業）、両方同時導入：56.8万円（中小企業）。就業規則に規定を整備し、実際に支払った実績が条件です。正社員化コースと組み合わせやすいです。",
    "conditions": [
      "就業規則に賞与・退職金規定を整備",
      "対象者に賞与または退職金を実際に支給"
    ],
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 750000,
    "amount_note": "小規模事業者（30人以下）：1年目50万円＋2年目25万円＝最大75万円/人。中小企業：1年目40万円＋2年目20万円＝最大60万円/人。大企業：最大45万円/人",
    "timing": "after_change",
    "lead_time_months": 6,
    "difficulty": 2,
    "company_size": [
    ...
    "description": "週所定労働時間が20時間未満のパートタイマーの労働時間を延長して社会保険に加入させた事業主に支給される助成金（短時間労働者労働時間延長支援コース）。小規模事業者（30人以下）は最大75万円/人（1年目50万＋2年目25万）、中小企業は最大60万円/人（1年目40万＋2年目20万）。旧「社会保険適用時処遇改善コース」は2026年3月末で終了し、本コースに再編されました。",
    "conditions": [
      "週所定労働時間を延長",
      "延長後6ヶ月雇用継続",
      "社会保険適用要件を満たす"
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 360000,
    "amount_note": "精神・発達障害者：月8万円×前半3ヶ月＋月4万円×後半3ヶ月＝最大36万円/人（最長6ヶ月）。身体・知的障害者等（精神以外）：月4万円×最長3ヶ月＝12万円/人",
    "timing": "before_hire",
    "lead_time_months": 4,
    "difficulty": 1,
    "company_size": [
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 480000,
    "amount_note": "月4万円×最大12ヶ月＝最大48万円/人（令和8年度改定。旧：月2万円・最大24万円）",
    "timing": "before_hire",
    "lead_time_months": 4,
    "difficulty": 1,
    "company_size": [
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 2400000,
    "amount_note": "重度障害者等（重度身体・知的、精神障害、45歳以上障害者）：240万円/3年/6回。重度以外の身体・知的障害者：120万円/2年/4回。60歳以上高齢者・母子家庭の母等：60万円/1年/2回（いずれも中小企業）",
    "timing": "after_hire",
    "lead_time_months": 9,
    "difficulty": 2,
    "company_size": [
    ...
    "description": "障害者・高齢者・母子家庭の母親など就職困難な方をハローワーク等の紹介で雇用した事業主に支給される助成金。重度障害者等は最大240万円（3年/6回）、重度以外の障害者は120万円（2年/4回）、60歳以上・母子家庭等は60万円（1年/2回）（いずれも中小企業）。雇い入れ後2週間以内に受給資格確認申請が必要です。なお令和8年5月1日以降、高年齢者（60歳以上）は個別支援を受けている方のみが対象となりました。",
    "conditions": [
      "ハローワーク等の紹介状が必須",
      "雇い入れ後2週間以内に受給資格確認申請",
      "1年以上の継続雇用見込み"
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 990000,
    "amount_note": "【令和8年度拡充】手当支給等（育児休業）最長1年以上：一般事業主81万円、プラチナくるみん認定事業主99万円/人（旧最高区分67.5万円から増額）。短時間勤務対応：最大67.5万円。代替要員新規雇用：最大67.5万円。有期雇用労働者加算：10万円",
    "timing": "before_hire",
    "lead_time_months": 1,
    "difficulty": 2,
    "company_size": [
    ...
    "description": "育児休業取得者や短時間勤務者の業務を代替する周囲の労働者に手当を支給、または代替要員を新規雇用した場合に受給できる助成金（2024年1月新設）。令和8年度から最長1年以上の育休の場合は一般事業主81万円/人（プラチナくるみん認定は99万円。旧最高67.5万円から増額）に拡充。業務代替者への手当支給に必要な雇用労働者数の要件も撤廃されより使いやすくなりました。育休者の「周囲の頑張り」に直接報いることができる制度です。",
    "conditions": [
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 1600000,
    "amount_note": "【2026年4月8日大改正】①65歳超継続雇用促進コース：定年廃止の場合最大160万円、継続雇用制度（70歳以上・10人以上）最大100万円。複数回申請可能に変更（1事業主1回限り廃止）。②高年齢者無期雇用転換コース：1人あたり40万円（中小企業）・30万円（中小企業以外）。③高年齢者評価制度等雇用管理改善コース：支出経費の60%（上限50万円）",
    "timing": "after_hire",
    "lead_time_months": 6,
    "difficulty": 2,
    "company_size": [
    ...
    "requires_employee_insurance": true,
    "min_employees": 1,
    "note_eligibility": "2026年4月8日大改正：①継続雇用促進コースは最大160万円（定年廃止）または100万円（継続雇用制度）。1事業主1回限り要件廃止・複数回申請可能に。専門家委託要件も廃止。②無期雇用転換コースは1人30万円→40万円（中小企業）に増額",
    "description": "65歳以降も継続して活躍できる職場環境を整備した事業主に支給される助成金（3コース）。2026年4月8日の大改正により改定。①65歳超継続雇用促進コース：65歳以上への定年廃止の場合最大160万円、継続雇用制度整備は最大100万円、複数回申請可能に（1事業主1回限り廃止）。②高年齢者無期雇用転換コース：50歳以上の有期→無期転換で1人あたり40万円（中小企業）に増額（旧30万円）。③高年齢者評価制度等雇用管理改善コース：制度整備経費の60%補助（上限50万円）。",
    "conditions": [
  ...
  },
  {
    ...
    "q14_key": "shooryoka",
    "max_amount": 6000000,
    "amount_note": "設備投資費の最大4/5（上限600万円）。事業場内最低賃金を50円以上引き上げることが条件【令和8年度：30円コース廃止、申請受付9月1日〜】",
    "timing": "before_investment",
    "lead_time_months": 6,
    "difficulty": 2,
    "company_size": [
    ...
    "requires_employee_insurance": true,
    "min_employees": 1,
    "note_eligibility": "【令和8年度】申請受付開始：令和8年9月1日。特例事業者（ア.事業場内最低賃金1,050円未満、またはイ.物価高騰等：直近6ヶ月利益率が前年比3%ポイント以上低下）は上限額拡大（最大600万円）。物価高騰等要件は助成対象経費も拡大（PC・スマホ等の端末も対象）",
    "description": "事業場内の最低賃金を50円以上引き上げることを条件に、生産性向上のための設備投資費用を助成する制度（令和8年度）。令和8年度から30円コースが廃止され、50円以上のコースに再編。申請受付は令和8年9月1日〜。一般の上限は引上げ額・人数で異なり最大450万円（特例事業者は最大600万円）。助成率は事業場内最低賃金800円未満で4/5、800円以上で3/4。",
    "conditions": [
      "中小企業・小規模事業者であること（雇用保険被保険者が1人以上）",
      "事業場内最低賃金を50円以上引き上げる計画（令和8年度より30円コース廃止）",
      "交付決定後に設備購入（令和8年9月1日以降の申請から対象）"
    ],
    "compatible_with": [
      "career-up-chingin-kaitei"
    ],
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 1500000,
    "amount_note": "対象費用の3/4（上限150万円）。インターバル制度導入に係る費用が対象。9時間以上11時間未満の新規導入（労働者1/2超）は100万円、11時間以上の新規導入（労働者1/2超）は150万円（令和8年度より120万円→150万円に引上げ）",
    "timing": "before_investment",
    "lead_time_months": 3,
    "difficulty": 2,
    "company_size": [
    ...
    "requires_employee_insurance": true,
    "min_employees": 1,
    "note_eligibility": "中小企業のみ対象。就業規則にインターバル規定を整備すること。令和8年度から11時間以上の新規導入（労働者1/2超）の上限が150万円に引上げ",
    "description": "勤務終了から次の勤務開始までに一定の休息時間（9時間以上）を確保する制度を就業規則に整備した際の費用を助成する制度。深夜労働・長時間シフトが多い飲食・宿泊・運輸等の業種に特に有効。費用の3/4（上限9時間〜11時間未満：100万円、11時間以上：最大150万円）が助成されます（令和8年度より11時間以上の上限が120万円→150万円に引上げ）。",
    "conditions": [
  ...
  },
  {
    ...
    "q14_key": null,
    "max_amount": 2250000,
    "amount_note": "【令和7年4月1日全面改定】コース名変更：「雇用管理制度・雇用環境整備助成コース」。制度ごとの定額支給：賃金規定制度・諸手当等制度・人事評価制度各40万円（賃上げ3%以上で50万円）、職場活性化制度・健康づくり制度各20万円（賃上げ3%以上で25万円）。複数制度合計上限：80万円（賃上げ3%以上で100万円）。業務負担軽減機器等導入：対象経費の1/2（上限150万円、賃上げ3%以上で最大225万円）",
    "timing": "after_hire",
    "lead_time_months": 12,
    "difficulty": 2,
    "company_size": [
    ...
    "requires_employee_insurance": true,
    "min_employees": 1,
    "note_eligibility": "中小企業のみ対象。令和7年4月1日より制度全面改定（旧「制度整備助成57万円＋離職率達成助成230万円」の構成は廃止）。複数制度の整備で最大80〜225万円。離職率は条件として残るが「達成時の加算」はなくなった",
    "description": "評価制度・賃金制度・研修制度などの雇用管理改善に取り組む中小企業に支給される助成金。令和7年4月1日より全面改定。旧「制度整備助成57万円＋離職率達成助成230万円（計最大287万円）」の構成は廃止され、制度ごとの定額支給（賃金規定・人事評価制度等：40万円/件、職場活性化等：20万円/件）に変更。業務負担軽減機器等（設備購入費）の助成も新設（上限150万円）。賃上げ3%以上で各加算あり（最大225万円）。",
    "conditions": [
  ...
  },
  {
    ...
    "q14_key": "jinzai",
    "max_amount": 887000,
    "amount_note": "【令和8年4月8日改正】訓練期間中の賃金助成：中小企業2/3（旧9/10から引下げ）。日額上限8,870円/人日。訓練費の別加算はなし（人材開発支援助成金との併用は別申請）。1事業所年度上限1,000万円",
    "timing": "before_training",
    "lead_time_months": 2,
    "difficulty": 2,
    "company_size": [
    ...
    "requires_employee_insurance": true,
    "min_employees": 1,
    "note_eligibility": "業況の変化等に対応するため、在籍型出向でスキルアップを図る場合に活用。出向期間中も雇用関係は出向元と継続。令和8年4月8日改正で助成率が9/10→2/3に変更（出向先事業主も新たに対象に追加）",
    "description": "業況悪化等で業務量が落ちた際に、解雇せず他社（出向先）でDX・IoT・新加工技術等のスキルを習得させ自社に還元する助成金。令和8年4月8日改正より賃金助成率は中小企業2/3（旧9/10）・日額上限8,870円に変更。出向先事業主も新たに申請対象に。雇用調整助成金（休業）との組み合わせも可能で、厳しい時期を乗り越えながら人材レベルを上げる戦略的な制度です。",
    "conditions": [
